$(document).ready(function () {
    ...
    var Menu = {
        body: $('div.quick'),
        button: $('div.quick div.button'),
        tools: $('div.quick div.tools'),
        top: $('div.quick div.top')
    };
    ...
    //문의하기 + 클릭
    var click_num = 0;
    $('div.quick div.button').click(function () {
        if (click_num == 0) {
            $('div.quick div.top').click(function () {
    ...
    //nav 클릭시 mob 문의하기 버튼 숨기기
    var click_num = 0;
    $('div.btn_nav').click(function () {
        if (click_num == 0) {
    ...
    //mob문의하기 버튼 클릭시 list 숨기기
     var click_num = 0;
    $('.mfb-component__wrap').click(function () {
        if (click_num == 0) {
            //+회전
            $('a.mfb-component__button--main').removeClass('m_rotate_init');
            $('a.mfb-component__button--main').addClass('m_rotate');
            
             //첫번째 메뉴 열림
            $('.mfb-component__button--child').removeClass('list_close');
            $('.mfb-component__button--child').addClass('list_open');
            ...
            //+회전
            $('a.mfb-component__button--main').removeClass('m_rotate');
            $('a.mfb-component__button--main').addClass('m_rotate_init');
            
            //첫번째 메뉴 닫힘
            $('.mfb-component__button--child').removeClass('list_open');
            $('.mfb-component__button--child').addClass('list_close');
    ...
    $(window).scroll(function () {
        ...
        if (sc == 0) {
            ...
            $('header ul.in_nav_login li a').css('background-image', 'url(' + '../img/login_w.png' + ')');
            ...
            $('header.cf').hover(function () {
                ...
                $('header ul.in_nav_login li a').css('background-image', 'url(' + '../img/login.png' + ')');
