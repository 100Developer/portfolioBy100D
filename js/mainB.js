$(document).ready(function () {
    ...
    //scrollout
    ScrollOut({
        targets: "section.product div.product_content h2.pro_tit,section.product div.product_content p.pro_text,section.product div.product_content ul.item_wrap li.item",
        threshold: 0.5,
        once: false
    });

    //제품/기능에 마우스 오버했을때
    $('section div.container ul.item_wrap li.item').hover(function () {
    ...
    //웹클리닉 버튼 마우스 오버했을때
    $('.clinic_content .try').hover(function () {
    ...
    //scrollout
    ScrollOut({
        targets: "section.b_product div.b_product_content div.b_product_wrap h2.b_pro_tit,section.b_product div.b_product_content div.b_product_wrap p.b_pro_text,section.b_product div.b_product_wrap a",
        threshold: 0.5,
        once: false
    });
